...
If you cannot produce a valid payload matching this schema, respond with a minimal valid object (use the example ID format shown above) and empty arrays for optional lists.
